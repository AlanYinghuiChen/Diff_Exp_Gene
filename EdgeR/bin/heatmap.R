...
pheatmap(countData_ok, clustering_distance_rows="correlation", clustering_distance_cols="correlation", clustering_method="ward.D", cluster_row=T, cluster_cols=T, scale="row", legend=TRUE, display_numbers=F, show_rownames=F, show_colnames=F, annotation_col=sample, annotation_colors=sample_color, col=mycolors)
dev.off()
